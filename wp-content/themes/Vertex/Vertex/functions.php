...
?>
	<style>
		#top-area{ background-image: url(http://localhost/BlogHarpia/wp-content/uploads/2014/11/bg.jpg); ?>); }
		#pre-footer {background-image: url(http://localhost/BlogHarpia/wp-content/uploads/2014/11/bg.jpg); ?>);}
	</style>
<?php
}
